 <div class="am-header">
      <div class="am-header-left">
        ...
        <a href="index.html" class="am-logo">Online Electrical Goods Registration System</a>
      </div><!-- am-header-left -->
  ...
  ?>
                ...
                <div class="media pd-x-20 pd-y-15">
                  ...
                  <div class="media-body">
                    <p class="tx-13 mg-b-0"><strong class="tx-medium">New Register: <?php echo $row->RegistrationNumber;?></strong><label style="color: green;padding-left: 10px"> <?php echo $row->HusbandName;?></label></p>
              ...
              <div class="media-list-footer">
                <a href="all-marriage-application.php" class="tx-12"><i class="fa fa-angle-down mg-r-5"></i> Show All Electrical Goods Registration</a>
              </div>
            </div><!-- media-list -->
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
