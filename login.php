...
<html lang="en">
  <head>
    ...
    <title>Online Electrical Goods Registration System|| Admin Sign In Page</title>
      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>SPKK</h2>
              <p>Welcome to SPKK Admin Panel</p>
              <p>To ensure that the residential colleges are safe environments, all residents will be required to have their electrical equipment or appliances safety tagged if they are to be used at college.</p>
...
<div class="form-group">
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Online Electrical Goods Registration System @ 2023</p>
      </div><!-- signin-box -->
