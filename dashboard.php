...
<html lang="en">
  <head>
    ...
    <title>Electrical Goods Registration System for Residential College</title>
              ...
              <div class="overlay-body pd-x-20 pd-t-20">
                <div class="d-flex justify-content-between">
                  <div>
                    ...
                    <p class="tx-12">New Registration</p>
                  </div>
            ...
            <div class="card">
              ...
              <div class="overlay-body pd-x-20 pd-t-20">
                <div class="d-flex justify-content-between">
                  <div>
                    <h6 class="tx-12 tx-uppercase tx-inverse tx-bold mg-b-5">Total</h6>
                    <p class="tx-12">Verified Registration</p>
                  </div>
            ...
            <div class="card">
              ...
              <div class="overlay-body pd-x-20 pd-t-20">
                <div class="d-flex justify-content-between">
                  <div>
                    <h6 class="tx-12 tx-uppercase tx-inverse tx-bold mg-b-5">Total</h6>
                    <p class="tx-12">Rejected Registration</p>
                  </div>
            ...
            <div class="card">
              ...
              <div class="overlay-body pd-x-20 pd-t-20">
                <div class="d-flex justify-content-between">
                  <div>
                    <h6 class="tx-12 tx-uppercase tx-inverse tx-bold mg-b-5">Total</h6>
                    <p class="tx-12">Total Registration</p>
                  </div>
