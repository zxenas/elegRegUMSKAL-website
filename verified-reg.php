...
<html lang="en">
  <head>
    ...
    <title>Online Electrical Goods Registration System || Verified Electrical Goods Registration</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Verified Electrical Goods Registration</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Verified Electrical Goods Registration</h6>
          ...
          <div class="table-wrapper" style="padding-top: 20px">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                <?php
$sql="SELECT * from tblregistration where Status='Verified'";
