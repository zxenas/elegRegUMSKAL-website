...
<html lang="en">
  <head>
    ...
    <title>Online Electrical Goods Registration System || Search Electrical Goods Registration</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Search Electrical Goods Registration</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Search Electrical Goods Registration</h6>
